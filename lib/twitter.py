...
class Favorite(object):
    ...
    def NewFromJsonDict(data):
      ...
      if 'user' in data:
        ...
        user = None
      return Favorite(created_at=data.get('created_at', None),
                    id=data.get('id', None),
                    status=status,
                    user=user)
...
class Api(object):
  ...
  def GetFavorites(self, user=None, page=None, since=None):
    ...
    if user:
      ...
      url = 'http://twitter.com/favorites/poeks.json'
...
class _FileCache(object):
  ...
  def _GetUsername(self):
    ...
    return settings.TWITTER['auth_user']
    try:
